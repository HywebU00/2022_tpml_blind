$(function() {
    ...
    /*-----------------------------------*/
    $('.header').after(
        '<aside class="sidebar"><button type="button" class="sidebarClose">關閉</button><div class="m_area"></div><div class="menu_overlay"></div><button type="button" class="sidebarClose">關閉</button></aside>'
        );
